  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[calc(4rem+16px+env(safe-area-inset-bottom,0px))] right-5 w-14 h-14 rounded-lg bg-white text-black flex items-center justify-center hover:bg-gray-100 active:scale-95 transition-all cursor-pointer z-40"
      >
