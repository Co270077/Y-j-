...
- [x] **Phase 3: UI Primitives + Animations** - Every tap target has feedback; data comes alive on screen (completed 2026-03-13)
...
- [ ] 04-01-PLAN.md — Upgrade Modal to BottomSheet with drag-to-dismiss and detents, extend Toast with undo action (Wave 1)
- [ ] 04-02-PLAN.md — Create useSwipeAction hook and SwipeActionRow wrapper component (Wave 1)
- [ ] 04-03-PLAN.md — Wire swipe gestures into pages, accordion expansion, undo-delete flow (Wave 2)
...
| 4. Gesture Interactions + Layout | 3/4 | In Progress|  |
